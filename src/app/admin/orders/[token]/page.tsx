      ...
      {(() => {
        ...
        const manifestText =
          [
            ...
            '',
            'Print target: 300 DPI for the album\'s physical inches.',
            '  Spread long edge = album_long_inch × 300 (24" → 7200 px, 30" → 9000 px)',
            '  Cover long edge  = album_face_inch × 300 (17" → 5100 px, 20" → 6000 px)',
            '',
