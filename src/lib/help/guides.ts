...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    area: 'adjust',
    keywords: 'zoom bigger smaller enlarge closer scale magnify zoom in zoom out crop tighter',
    steps: [
      'Click the photo.',
      'Drag the Zoom slider, or press − / +.',
      'You can also hold Ctrl (⌘ on Mac) and scroll over the photo, or pinch on a trackpad.',
    ],
    touch: ['Tap the photo, then pinch with two fingers.'],
