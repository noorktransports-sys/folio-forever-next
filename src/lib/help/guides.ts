...
export const GUIDES: Guide[] = [
  ...
  // ────────────────────────────── Magazine ───────────────────────────────
  {
    ...
    area: 'magazine',
    keywords: 'magazine style design theme look terracotta noir ivory sage couture maharani sienara noctelle perlaine fernelle velmora zarivelle filmara rosavie marazur aurique analog blush riviera gilded change style switch design different design',
    steps: [
      'At the top of the magazine page, click one of the 10 style cards — SIENARA, NOCTELLE, PERLAINE, FERNELLE, VELMORA, ZARIVELLE, FILMARA, ROSAVIE, MARAZUR or AURIQUE.',
    ...
    tips: ['Every style is 20 pages at the same price, and page 1 is a real magazine cover. Switching resets swaps and crops.'],
    demo: 'layout',
  ...
  {
    id: 'mag-names',
    title: 'Put our names and wedding date in the magazine',
    area: 'magazine',
    keywords: 'names name bride groom date wedding date couple title cover names fill in',
    steps: [
      'Near the top of the magazine page, find “Your names & date”.',
      'Type the bride’s name, the groom’s name and the wedding date.',
      'Every headline, cover and caption updates straight away.',
    ],
    tips: ['Text you have already rewritten by hand keeps your words.'],
    demo: 'click',
    demoLabel: 'Your names & date',
    popular: true,
  },
  {
    id: 'mag-text-edit',
    title: 'Edit, restyle or move magazine text',
    area: 'magazine',
    keywords: 'text edit change words font size colour move headline story caption title writing rewrite style bold italic',
    steps: [
      'After building, click any text on a page — the text toolbar opens at the bottom.',
      'Type new words in the box, pick a font (Bodoni, Playfair, Cormorant, Italiana, Cinzel, Pinyon, Great Vibes, Montserrat), then adjust size, width, spacing and colour.',
      'Drag the text on the page to move it. Press Done when finished.',
    ],
    tips: ['What you see is exactly what prints.'],
    demo: 'text',
    target: ['.mag-text-edit'],
    popular: true,
  },
  {
    id: 'mag-text-add',
    title: 'Add or delete text on a magazine page',
    area: 'magazine',
    keywords: 'add text new text delete text remove text restore original text caption quote',
    steps: [
      'Under any page, press + Text — a new line appears in the middle of the page.',
      'To remove text, click it and press Delete text.',
      'Changed your mind? Press ↺ Restore text under that page to bring back the original words.',
    ],
    demo: 'text',
    target: ['[data-help="mag-add-text"]'],
  },
  {
    id: 'mag-order',
    title: 'Order my magazine (checkout)',
    area: 'magazine',
    keywords: 'order buy checkout pay payment purchase print submit magazine price shipping approve proof',
    steps: [
      'Scroll to the bottom and press Review & order · $70.',
      'Check all 20 pages (page 1 is your cover), tick the two approval boxes, then Approve & continue.',
      'Fill in your shipping details and press Continue to secure payment — you pay on the secure Square page.',
    ],
    tips: ['Print files are made at 300 DPI while you wait (about a minute) — keep the page open.', 'Shipping is arranged separately.'],
    demo: 'click',
    demoLabel: 'Review & order · $70 →',
    target: ['[data-help="mag-order"]'],
    popular: true,
  },
  {
    id: 'mag-email',
    title: 'Email my magazine design to myself',
    area: 'magazine',
    keywords: 'email send preview share family myself save copy watermark pdf images',
    steps: [
      'At the bottom of the magazine page, press ✉ Email me a preview.',
      'Type your email and press Send my preview.',
      'You receive all 20 pages as watermarked preview images — the printed magazine has no watermark.',
    ],
    tips: ['To order later, come back on the same device and browser — your design is saved there.'],
    demo: 'click',
    demoLabel: '✉ Email me a preview',
    target: ['[data-help="mag-email"]'],
  },
  {
    id: 'mag-build',
    title: 'Build my magazine (auto-design)',
    area: 'magazine',
    keywords: 'magazine build create make upload photos rebuild auto design automatic one click redesign',
    steps: [
      'Press + Upload photos and choose your photos (about 35–40 fill every page).',
      'That’s it — the magazine designs itself automatically, placing photos in date order.',
      'Added more photos later? Press ✨ Auto-design with all photos to redesign using every photo.',
    ],
    tips: ['Uploading your own photos replaces the sample photos automatically.'],
    demo: 'upload',
